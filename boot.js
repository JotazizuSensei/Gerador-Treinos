(async()=>{try{
const DATA_FILES=["data-1.txt", "data-2.txt", "data-3.txt", "data-4.txt", "data-5.txt", "data-6.txt", "data-7.txt"];const CODE_FILES=["code-1.txt", "code-2.txt", "code-3.txt", "code-4.txt", "code-5.txt", "code-6.txt", "code-7.txt"];
...
const c=JSON.parse(await readAll(DATA_FILES));const fs=c.exerciseSchema.dictFields,ds=c.exerciseSchema.dictionaries;
